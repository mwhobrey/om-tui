...
func (a *App) whatsAppSessionPathFor(riverID string) string {
	...
	return filepath.Join(river.SessionDir(a.DataDir, riverID), "whatsapp-session.db")
}
...
func (a *App) signalConfigPathFor(riverID string) string {
	...
	return filepath.Join(river.SessionDir(a.DataDir, riverID), "signal-cli")
}
...
func (a *App) ensureWhatsAppRiver(riverID string) (*whatsapplive.Bridge, error) {
	...
	bridge, err := whatsapplive.NewForRiver(riverID, a.whatsAppSessionPathFor(riverID), a.Store, a.Logger, whatsapplive.Callbacks{
...
func (a *App) ensureSignalRiver(riverID string) (*signallive.Bridge, error) {
	...
	bridge, err := signallive.NewForRiver(riverID, a.signalConfigPathFor(riverID), a.Store, a.Logger, signallive.Callbacks{
		OnConversationsChange: a.emitConversationsChange,
		OnIncomingMessage:     a.OnIncomingMessage,
		OnMessagesChange:      a.emitMessagesChange,
		OnStatusChange: func() {
